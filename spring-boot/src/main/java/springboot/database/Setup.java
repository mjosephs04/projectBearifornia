...
public class Setup {
    ...
    private static void initDbTables(Connection conn) {
        String[] tableCreationCommands = {
                ...
                "CREATE TABLE PRODUCTS (productId VARCHAR(255) PRIMARY KEY, productName VARCHAR(255), productStock INT, productDescription VARCHAR(255), productPrice DECIMAL(10, 2), imageURL VARCHAR(2048), category VARCHAR(255))",
        };
